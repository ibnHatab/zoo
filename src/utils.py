...
def graph_forward(net, X, depth=1):
    model_graph = draw_graph(net, input_size=X.shape, expand_nested=True, depth=depth)
    model_graph.visual_graph.render("rnn_torchview", format="png", view=True)
