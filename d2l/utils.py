...
dtach_np = lambda x, *args, **kwargs: x.detach().numpy(*args, **kwargs)
...
class Module(nn.Module, HyperParameters):
    """Defined in :numref:`sec_oo-design`"""
    def __init__(self, plot_train_per_epoch=2, plot_valid_per_epoch=1, num_gpus=1):
        super().__init__()
        self.save_hyperparameters()
    ...
    def plot(self, key, value, train):
        ...
        self.board.draw(x, dtach_np(value.to('cpu')),
...
if __name__ == "__main__":
    ...
    plot(x, x**2, 'x', 'x^2', xlim=[-1, 12], ylim=[-5, 120], legend=['x vs. x^2'])
